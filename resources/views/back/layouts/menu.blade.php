...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Sidebar - Brand -->
        <a class="sidebar-brand d-flex align-items-center justify-content-center disabled">
        ...
        <li class="nav-item">
            <a class="nav-link @if(!request()->segment(2)=="makaleler")collapse @endif"   href="#" data-toggle="collapse" data-target="#collapseTwo"
            ...
            <div id="collapseTwo" class="collapse @if(request()->segment(2)=="makaleler") show @endif " aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item @if(request()->segment(2)=="makaleler" and !request()->segment(3)) active @endif" href="{{route('admin.makaleler.index')}}">Tüm yazılar</a>
                    <a class="collapse-item @if(request()->segment(2)=="makaleler" and request()->segment(3)=="create") active @endif" href="{{route('admin.makaleler.create')}}">Yazı oluştur</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" @if(request()->segment(2)=="kategoriler") style="color: white !important;" @endif href="{{route('admin.category.index')}}">
